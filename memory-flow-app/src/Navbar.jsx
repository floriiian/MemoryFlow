...
function Navbar() {
    ...
    window.onload = () => {
        ...
        const dailyGoalPercentage = document.querySelector('.inner-goal-progress-bar');
        const dailyGoalText = document.querySelector('.process-bar-text');
        const levelText = document.querySelector('.progress-text.level');
        const streakText = document.querySelector('.progress-text.level');
                ...
                <div className="progress-bar-navigation">
                    <div className={"progress-header"}>
                        <div className={"progress-display"}>
                            ...
                            <span className={"progress-text streak"}>0</span>
